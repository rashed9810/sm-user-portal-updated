        ...
        <div>
            ...
            <div className='space-y-3'>
                <div className="w-full">
                    <label className="block mb-1 font-bold ">Enter Your Amount</label>
                    <input
                        type="text"
                        name="amount"
                ...
                <div className="w-full">
                    <label className="block mb-1 font-bold ">Deposit Bank and Account Number</label>
                    <input
                        type="text"
                        name="account&bank"
                        className="w-full px-3 py-1  border border-gray-400 rounded-full focus:outline-none placeholder:text-red-600"
                        placeholder="USA Bank | Account Number : 1586512384325"
                    />
                </div>
                <div className="w-full">
                    <label className="block mb-1 font-bold ">Enter Transaction ID</label>
                    <input
                        type="text"
                        name="transactionID"
                        className="w-full px-3 py-1  border border-gray-400 rounded-full focus:outline-none"
